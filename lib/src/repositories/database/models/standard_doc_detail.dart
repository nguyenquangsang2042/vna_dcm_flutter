...
class StandardDocDetail {
  ...
  factory StandardDocDetail.fromMap(Map<String, dynamic> map) {
    return StandardDocDetail(
      ID: map['ID']?.toInt() ?? 0,
      Title: map['Title'] ?? '',
      Url: map['Url'] ?? '',
  ...
  factory StandardDocDetail.fromJson(String source) =>
      StandardDocDetail.fromMap(json.decode(source));
}
