...
import {ListDetailFavoriteScreen} from "./ListDetailFavoriteScreen";
import {ThumpDetailFavoriteScreen} from "./ThumpDetailFavoriteScreen";
        ...
        >
            {
                menuItems.length != 0 ? menuItems.map((item: any) => (
                        ...
                        >
                            <Text
                                style={styles.menuItem}>{item["Title"]}</Text>
                        </TouchableOpacity>
                    )) :
                    <NoDataView/>
            }
...
export const DetailFavoriteScreen = () => {
    ...
    useEffect(() => {
        FavoriteFolder.getChildByParentId(positionStayFavorite[positionStayFavorite.length - 1].PrimaryKey).then(values => {
             setMenus(values);
        })
        ...
        <View style={styles.container}>
            ...
            <View style={styles.headerContainer}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>{positionStayFavorite[positionStayFavorite.length - 1].Title}
                    </Text>
                </View>
                <View style={{padding: 10}}>
            ...
            <ImageBackground source={require('assets/images/background.png')} style={{
                ...
                {
                    columnFlatlist==1?
                        <ListDetailFavoriteScreen/>:
                        <ThumpDetailFavoriteScreen/>
                }
